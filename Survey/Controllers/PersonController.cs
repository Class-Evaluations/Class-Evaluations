...
namespace Survey.Controllers
{
    public class PersonController : Controller
    {
       ...
       protected override void Dispose(bool disposing)
        ...
        //Creates the database entries and send out the email to client with survey link 
       [HttpPost]
       ...
       //Create hash code
       public ContentResult CreatePersonHash(string personhash)
       {
           byte[] data = new byte[256];


           //Spilt off to a class called CreatePersonHash
           SHA1 sha = new SHA1CryptoServiceProvider();
